...
// diabetes-display-result.js
class DiabetesDisplayResultClass {
  constructor() {
    this.dbName = "DiabetesResults";
    this.version = 1;
...
export const DiabetesDisplayResult = new DiabetesDisplayResultClass();
